...
jQuery(document).ready(function ($) {
    var Video_back = new video_background($("#home"), {
        ...
        "mp4": "/preview.mp4",     //Path to video mp4 format
        "ogg": "/preview.ogg",     //Path to video ogg format
        "webm": "/preview.webm",     //Path to video webm format
        "video_ratio": 1.7778,              // width/height -> If none provided sizing of the video is set to adjust
        "fallback_image": "/dummy.png",   //Fallback image path
